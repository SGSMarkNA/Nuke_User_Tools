##----------------------------------------------------------------------------------------------------------------------
##
##          'Manual' TAB of the Group Node's 'Select All' PyScript Button:
##
##   The code in the section below gets loaded into the 'Select All' button (PyScript_Knob) of the Group node
