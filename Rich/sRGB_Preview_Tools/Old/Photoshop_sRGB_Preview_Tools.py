...
class Add_sRGB_Preview_Tools(object):
	...
	def _create_sRGB_3dLUT_vectorfield_node(self):
		...
		# Set the os-dependent LUT file path...
		if os.name == 'nt':
			self.Vectorfield_sRGB_LUT.knob('vfield_file').setValue('//isln-smb/aw_config/Git_Live_Code/Software/Nuke/LUTs/Nuke_Round_Trip.3dl')

		elif os.name == 'posix':
			if os.getenv('USER') == 'richbobo':
				self.Vectorfield_sRGB_LUT.knob('vfield_file').setValue('/Users/richbobo/Dropbox/CODE/aw_LIVE_CODE/Git_Live_Code/Software/Nuke/LUTs/Nuke_Round_Trip.3dl')
			elif os.getenv('USER') == 'rich.bobo':	
				self.Vectorfield_sRGB_LUT.knob('vfield_file').setValue('/Volumes/aw_config/Git_Live_Code/Software/Nuke/LUTs/Nuke_Round_Trip.3dl')
		...
		# Activate the new Vectorfield LUT...
