# FOV Panel v1.1 by Frank Rueter
...
# The preset list is read from a text file called "apertures.txt" in your plugin path (an example is in the zip file).
# this way people can configure their own presets. If no such file is found, the drop down knob will not appear.
